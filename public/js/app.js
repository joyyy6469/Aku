...
// Get reference to country options container
const countryOptionsContainer = document.getElementById("countryOptions");

// Loop through countries array to generate country options
countries.forEach((country) => {
  // Create a div element for each country option
  const countryOption = document.createElement("div");
  countryOption.classList.add("countryOption");

  // Set onclick event to set country code and display name
  countryOption.onclick = function () {
    document.querySelector(".iconNum strong").textContent = "+" + country.phone;
    document
      .querySelector(".iconify")
      .setAttribute("data-icon", `flag:${country.code.toLowerCase()}-4x3`);
    document
      .getElementById("phone")
      .setAttribute("placeholder", `Phone Number`);
    // Hide country options after selection
    document.getElementById("countryOptions").style.display = "none";
  };

  // Set inner HTML of country option
  ...
  // Append country option to country options container
